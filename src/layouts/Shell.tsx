        ...
        >
          ...
          >
            ...
            <button
              ...
              className="p-1 text-slate-400 hover:text-slate-800 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-white/10 rounded transition-all"
            >
              <Minus size={12} />
            </button>
            ...
            <button
              onClick={handleClose}
              className="p-1 text-slate-400 hover:text-red-500 hover:bg-red-100 dark:hover:bg-white/10 rounded transition-all"
            >
              <X size={12} />
            </button>
          </div>
