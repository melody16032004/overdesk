...
import { PRESET_COLORS } from "./constants/signature_const";
import { SavedSignature } from "./types/signature_type";
...
export const SignatureModule = () => {
  ...
  // Zoom Handler (Passive Event Listener)
  useEffect(() => {
  ...
  // Reload Canvas Data after Resize
  useEffect(() => {
    if (
      canvasSize.width > 0 &&
      canvasSize.height > 0 &&
